...
<html>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            <ul class="nav menu">
                <li id="pshunt"><a href="/SignUpSys/index.php/Student/choiced"><span class="glyphicon glyphicon-dashboard"></span> 专业分流选择</a></li>
                <li class="active"><a href="/SignUpSys/index.php/Training/choiced"><span class="glyphicon glyphicon-dashboard"></span> 实训课程选择</a></li>
            </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                    <ol class="breadcrumb">
                            ...
                            <li class="active">实训课程选择</li>
                            <li><?php echo $profession; ?></li>
                    </ol>
            </div><!--/.row-->

            <div class="row">
                <div><p>你当前选择的实训课程</p></div>
